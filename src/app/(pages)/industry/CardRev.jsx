...
export default function CardRev(props) {
  return (
    <div className='h-[420px] mb-[30px] bg-[#e8ecdf] w-[1120px] rounded-[20px] flex flex-row-reverse m-auto' >
...
Measurement
      ...
      <div className='w-1/2 bg-[#d2d8c5] rounded-l-[20px]'>
