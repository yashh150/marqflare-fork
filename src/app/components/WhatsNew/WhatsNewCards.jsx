...
export default function WhatsNewCards(props) {
  ...
  return (
    <div class="w-[600px] mt-[50px] p-[48px] h-[300px] flex flex-col bg-[#464b37] rounded-[20px]">
        ...
        <p class="whitespace-pre-line mt-[15px] text-white text-lg font-normal leading-normal tracking-tight">{props.feature.desc}</p>
        <span className="flex flex-row mt-[16px]">
